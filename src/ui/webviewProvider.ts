    ...
    private _getHtml(webview: vscode.Webview) {
        ...
        <body>
            ...
            <script>
                ...
                function updateGridSelection(maxR, maxC) {
                    sizeInfo.innerText = \`Size: \${maxR} x \${maxC}\`;
                ...
                function insertTable() {
                    ...
                    const alignment = document.getElementById('tbl-align').value;
                    const hasBorders = document.getElementById('tbl-border').checked;
